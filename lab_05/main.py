from algorithm import CAP_algorithm_with_ordered_list_of_edges, Point
...
dataFrame.pack(side=tk.RIGHT, padx=BORDERS_SPACE, fill=tk.Y)
# ------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
tk.Radiobutton(dataFrame, variable=methodDraw, text="Задержкой", value=0, bg=MAIN_FRAME_COLOR,
                font=("Consolas", 16), justify=tk.LEFT, fg="black", selectcolor="#ffe080",
...
makePoint += 0.4
listPoint_scroll.place(x=1550, y=(makePoint + 4) * DATA_FRAME_HEIGHT // COLUMNS, width=DATA_FRAME_WIGHT - 60, height=6 * DATA_FRAME_HEIGHT // COLUMNS)
# ------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
canvasField.place(x=0, y=BORDERS_SPACE, width=CANVAS_WIDTH, height=CANVAS_HEIGHT)
...
timeLabel.place(x=0 * BORDERS_SPACE, y=CANVAS_HEIGHT + BORDERS_SPACE - DATA_FRAME_HEIGHT // COLUMNS, width=DATA_FRAME_WIGHT - 60, height=DATA_FRAME_HEIGHT // COLUMNS)
